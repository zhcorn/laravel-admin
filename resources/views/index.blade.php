...
<head>
    ...
    <script src="{{ admin_asset ("/vendor/laravel-admin/jquery-pjax/jquery.pjax.min.js") }}"></script>
...
<script src="{{ admin_asset ("/vendor/laravel-admin/AdminLTE/dist/js/manager.js") }}"></script>
